...
public class AppleTree : Plant {
	private static List<KeyValuePair<KeyValuePair<Food, int>, int>> FOOD_LIST = new List<KeyValuePair<KeyValuePair<Food, int>, int>> {
		...
		new KeyValuePair<KeyValuePair<Food, int>, int> (new KeyValuePair<Food, int>(new Leaf(), 5), 1),
		// Generate 1 fruit every 3 ticks
		new KeyValuePair<KeyValuePair<Food, int>, int> (new KeyValuePair<Food, int>(new Fruit(), 1), 3),
		// Generate 7 bugs every 3 ticks. They like the fruits.
		new KeyValuePair<KeyValuePair<Food, int>, int> (new KeyValuePair<Food, int>(new Bugs(), 7), 3)
	};
